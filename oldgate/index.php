...
<?php
  ...
  if ($u == 1) {
    ...
    $strtl = "<a href=\"/gate/\">в начало</a>";
  }
  $nextl = "<a href=\"/gate/?" . $us . "c=" . $pr ."\">следующие 20</a>";
  $prevl = "<a href=\"/gate/?" . $us . "c=" . $ne . "\">предыдущие 20</a>";
?>
...
<td><div align=\"right\"><a href=\"/send/?id=" . $s[0] . "\">ответить</a></div></td>
</tr></table></td></tr>
...
printf ("время выполнения %.3f сек", $totaltime);
?>
</td>
